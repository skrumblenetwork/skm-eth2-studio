...
skm-debug wrap other skm-* libraries and can be used to debug Skrumble transactions.
...
```bash
npm install skm-debug
```

## Development

```javascript
var Debugger = require('skm-debug').EthDebugger
var BreakpointManager = require('skm-debug').BreakpointManager
