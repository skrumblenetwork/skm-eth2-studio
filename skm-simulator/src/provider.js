const log = require('./utils/logs.js.js')
const merge = require('merge')

const Accounts = require('./methods/accounts.js.js')
const Blocks = require('./methods/blocks.js.js')
const Misc = require('./methods/misc.js.js')
const Net = require('./methods/net.js.js')
const Transactions = require('./methods/transactions.js.js')
const Whisper = require('./methods/whisper.js.js')
